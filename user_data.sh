...
# # Clear existing content from the web directory
# sudo rm -rf "${WEB_DIR:?}"/*

# # Clone the public repository into the web directory
# sudo git clone https://github.com/omokarogabriel/my-port-folio.git "$WEB_DIR"
